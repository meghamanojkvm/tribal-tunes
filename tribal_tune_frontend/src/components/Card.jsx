...
export const Card = ({ title, description, imageUrl, profileUrl }) => {
  ...
  return (
    <div className="relative h-[300px] w-[300px] rounded-md my-4">
      ...
      {user.current ? <div onClick={() => navigate("/addinstrument")}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
